...
describe UsersController do
  ...
  describe "GET index" do
    it "assigns all users as @users" do
      ...
      assigns(:users).should eq([@existing_user])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user" do
        ...
        put :update, {:id => @existing_user.to_param, :user => {'these' => 'params'}}, valid_session
      end

      it "assigns the requested user as @user" do
        put :update, {:id => @existing_user.to_param, :user => valid_update}, valid_session
        assigns(:user).should eq(@existing_user)
      end
    ...
    describe "with invalid params" do
      it "assigns the user as @user" do
        # Trigger the behavior that occurs when invalid params are submitted
        User.any_instance.stub(:save).and_return(false)
        put :update, {:id => @existing_user.to_param, :user => {}}, valid_session
        assigns(:user).should eq(@existing_user)
      end
